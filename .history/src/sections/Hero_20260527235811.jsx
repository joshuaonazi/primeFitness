  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
        ...
        >
          <a href="#pricing" className="bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-full font-bold text-lg transition-colors duration-200 w-full sm:w-auto">
            Join Now
          </a>
          <a href="#services" className="border-2 border-white hover:border-green-400 hover:text-green-400 text-white px-8 py-4 rounded-full font-bold text-lg transition-colors duration-200 w-full sm:w-auto">
            View Programs
          </a>
        </motion.div>
      </div>
